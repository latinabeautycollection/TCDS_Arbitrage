...
const boolString = z.enum(["true", "false"]).transform((v: string) => v === "true");

const schema = z.object({
  // Executor/process switches only. 10A channel_controls remains authoritative.
  DOMAIN10_DELIVERY_ENABLED: boolString.default("false"),
  DOMAIN10_DELIVERY_EMAIL_ENABLED: boolString.default("false"),
  DOMAIN10_DELIVERY_SMS_ENABLED: boolString.default("false"),
